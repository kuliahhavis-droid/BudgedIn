...
export const reportService = {
    async monthly(userId, month, year) {
        ...
        const byCategory = Object.values(transactions.reduce((acc, item) => {
    ...
    async dashboard(userId, queryMonth, queryYear) {
        const now = new Date();
        ...
        const healthScore = Math.max(0, Math.min(100, Math.round(50
